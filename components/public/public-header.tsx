...
export function PublicHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#d9d2c5]/80 bg-[#fbf8f1]/88 backdrop-blur-xl">
      <div className="mx-auto flex min-h-[72px] w-full max-w-[1360px] items-center justify-between gap-4 px-4 py-2 sm:px-6 lg:max-w-[1480px] lg:px-10 xl:max-w-[1560px] xl:px-12">
        <Link href="/" className="flex min-w-0 items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0">
            <p className="truncate text-[1.45rem] font-black leading-none tracking-[-0.02em] text-[#18211d] sm:text-[1.75rem]">
              해밀학교
            </p>
          </div>
        </Link>
